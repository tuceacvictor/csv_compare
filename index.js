...
const generateDeltaFile = (pathToBaseFile, pathToFileForComparison, pathForOutputFileName = './result/difference.csv') => {
...
generateDeltaFile('./source/fileOne.csv', './source/fileTwo.csv')